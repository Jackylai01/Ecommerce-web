...
export const apiGetInventoryOverviewReport = async () =>
  getRequest<ApiResult<InventoryReport>>('/zigong/erp/overview');

// 庫存歷史變動
export const apiGetInventoryMovementsReport = async () =>
  getRequest<ApiResult<IStockMovement[]>>('/zigong/erp/movements');

// 庫存預測
export const apiGetInventoryForecastReport = async () =>
  getRequest<ApiResult<InventoryForecast[]>>('/zigong/erp/forecast');

// 庫存警報
export const apiGetInventoryAlertsReport = async () =>
  getRequest<ApiResult<InventoryAlert[]>>('/zigong/erp/alerts');

// 庫存詳情
export const apiGetInventoryDetailsReport = async (productId: string) =>
  getRequest<ApiResult<SalesOrderReport[]>>(`/zigong/erp/details/${productId}`);

// 庫存趨勢分析
export const apiGetInventoryTrends = async () =>
  getRequest<ApiResult<InventoryTrends[]>>(`/zigong/erp/trends`);
