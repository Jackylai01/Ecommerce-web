import { Box, Button, ButtonGroup, Popover, PopoverTrigger, PopoverContent, VStack, Input, Select } from '@chakra-ui/react';
...
const EditorToolbar: React.FC<EditorToolbarProps> = ({ editor }) => {
  ...
  return (
    <Box
      ...
      shadow='sm'
    >
      <ButtonGroup size='sm' spacing={1} variant='solid' flexWrap='wrap'>
        {/* 文字格式 */}
        <Button
